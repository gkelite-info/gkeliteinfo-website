            ...
            <main className="main">
                ...
                <section id="skills" className="skills section">
                    ...
                    <div className="our-story container" >
                        ...
                        <ul>
                            <li><i className="bi bi-check-circle" style={{ marginTop: 0 }}></i> <span>As one of the fastest-growing talent acquisition platforms, we are the preferred recruiting partner for numerous Fortune 500 companies.</span></li>
